...
<div class="tabela">  
        <table>
  <div class="topos"></div>             
            <thead style="font-size: 20px; margin-left: 40px; margin-right:30px;">
              
                <tr>
                    <th style="margin-left: 10px; margin-right:10px;">ID</th>
                    <th style="margin-left: 10px; margin-right:10px;">NOME</th>
                    <th style="margin-left: 10px; margin-right:10px;">IDADE</th>
                    <th style="margin-left: 10px; margin-right:10px;">ENDERECO</th>
                    <th style="margin-left: 10px; margin-right:10px;">DATA NACIMENTOS</th>

                    <th style="margin-left: 10px; margin-right:10px;">MATRICULA</th>
                </tr>
